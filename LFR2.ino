...
void loop()
{
    ...
    int position = qtrrc.readLine(sensors); //QTR sensors onujai data read korbe, infrared o use kora jai
    ...
    // motor speed 2 ta motor diye niyontron kora jabe
    set_motors(leftMotorSpeed, rightMotorSpeed);
}
  
void set_motors(int motor1speed, int motor2speed)
{
    if(motor1speed > M1_maksimum_speed )
         motor1speed = M1_maksimum_speed;
    if(motor2speed > M2_maksimum_speed ) 
        motor2speed = M2_maksimum_speed;
